package com.tasko.task.application.fetch.impl;

import com.tasko.task.application.fetch.TodayFetchService;
...
import com.tasko.task.domain.repository.user.UserRepository;
...
@Service
public class TodayFetchServiceImpl implements TodayFetchService {
